...
export const categories: Category[] = [
  {
    ...
    details: [
      ...
      { detailTitle: "Cleaning", amount: 200, symbol: RiMoneyEuroCircleFill },
      {
        detailTitle: "Comunication",
        amount: 45,
        symbol: RiMoneyEuroCircleFill,
  ...
  },
  {
    ...
    symbol: BiCategoryAlt,
    details: [
      { detailTitle: "Continente", amount: 80, symbol: RiMoneyEuroCircleFill },
      { detailTitle: "Wholesale", amount: 200, symbol: RiMoneyEuroCircleFill },
      { detailTitle: "Mercadona", amount: 30, symbol: RiMoneyEuroCircleFill },
    ],
  },
  {
    title: "Taxes",
    ...
    symbol: BiCategoryAlt,
    details: [
      { detailTitle: "Property", amount: 90, symbol: RiMoneyEuroCircleFill },
  ...
  },
  {
    ...
    details: [
      ...
      { detailTitle: "Ski Trip", amount: 1500, symbol: RiMoneyEuroCircleFill },
    ],
  },
  {
    title: "Subscriptions",
